...
public:
	...
	void SetTransAndScale(float fTransX, float fTransY);
	void SetTransAndScale(float fTransX, float fTransY, float fScale);
	void MyBulletMotion(float dt);
	void EnemyABulletMotion(float dt);
