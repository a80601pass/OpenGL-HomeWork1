...
void BIGSTAR::CreateBufferObject()
{
...
void BIGSTAR::SetShader(mat4 &mxView, mat4 &mxProjection, GLuint uiShaderHandle)
{
...
void BIGSTAR::SetViewMatrix(mat4 &mat)
{
	m_mxView = mat;
	m_bUpdateMV = true;
}

void BIGSTAR::SetProjectionMatrix(mat4 &mat)
{
	m_mxProjection = mat;
	m_bUpdateProj = true;
}

void BIGSTAR::SetTRSMatrix(mat4 &mat)
{
	m_mxTRS = mat;
	m_bUpdateMV = true;
}

void BIGSTAR::SetColor(GLfloat vColor[4])
{
	for (int i = 0; i < 6; i++) {
...
void BIGSTAR::SetVtxColors(GLfloat vLFColor[], GLfloat vLRColor[], GLfloat vTRColor[], GLfloat vTLColor[])
{
...
void BIGSTAR::SetTrans(float fTransX, float fTransY)
{
	glUseProgram(m_uiProgram);
