...
void MYPLANE::CreateBufferObject()
{
...
void MYPLANE::SetShader(mat4 &mxView, mat4 &mxProjection, GLuint uiShaderHandle)
{
...
void MYPLANE::SetViewMatrix(mat4 &mat)
{
	m_mxView = mat;
	m_bUpdateMV = true;
}

void MYPLANE::SetProjectionMatrix(mat4 &mat)
{
	m_mxProjection = mat;
	m_bUpdateProj = true;
}

void MYPLANE::SetTRSMatrix(mat4 &mat)
{
	m_mxTRS = mat;
	m_bUpdateMV = true;
}

void MYPLANE::SetColor(GLfloat vColor[4])
{
	for (int i = 0; i < 6; i++) {
...
void MYPLANE::SetVtxColors(GLfloat vLFColor[], GLfloat vLRColor[], GLfloat vTRColor[], GLfloat vTLColor[])
{
...
void MYPLANE::SetTrans(float fTransX, float fTransY)
{
	glUseProgram(m_uiProgram);
